...
def prompt_formatting(
    ...
    sentence_len = num_tokens_from_messages(sentence, deployment_name)
    ...
    if total_len > context_len:
        ...
        # Determined by cosine similarity between topic string & document embedding
            ...
            prompt = generation_prompt.format(Document=doc, Topics=seed_str, Sentence = sentence)
    else:
        prompt = generation_prompt.format(Document=doc, Topics=topic_str, Sentence = sentence)
    return prompt
    ...
    for i, doc in enumerate(tqdm(docs)):
        ...
        for j in sentences_json:
            ...
            try:
                ...
                sentences_response.append(result_json)
        responses.append(sentences_response)
    return responses, topics_list, topics_root
